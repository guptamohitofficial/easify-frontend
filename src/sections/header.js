      ...
      <div className="container">
        ...
        <a className="logo" href="index.html">
          <div className="block sm:hidden">
            <img
              src="https://shreethemes.in/jobstack/layouts/assets/images/logo-icon-40.png"
              className="h-10 inline-block dark:hidden"
              alt=""
            />
            <img
              src="https://shreethemes.in/jobstack/layouts/assets/images/logo-icon-40-white.png"
          ...
          <div className="sm:block hidden">
            <span className="inline-block dark:hidden">
              <img
                src="https://shreethemes.in/jobstack/layouts/assets/images/logo-dark.png"
                className="h-[24px] l-dark"
                alt=""
              />
              <img
                src="https://shreethemes.in/jobstack/layouts/assets/images/logo-light.png"
                className="h-[24px] l-light"
                alt=""
              />
            </span>
            <img
              src="https://shreethemes.in/jobstack/layouts/assets/images/logo-white.png"
